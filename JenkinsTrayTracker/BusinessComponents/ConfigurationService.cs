...
using Jenkins.TrayTracker.Utils.IO;
using System.IO;
using System.Reflection;
using Common.Logging;
using Newtonsoft.Json;

namespace Jenkins.TrayTracker.BusinessComponents
{
    public class ConfigurationService
    {
        ...
        const string JENKINS_TRAY_TRACKER_DIRECTORY = "Jenkins Tray";
        ...
        public void Initialize()
        {
            ...
            string userAppDataPath = PathHelper.Combine(userAppDataDir, JENKINS_TRAY_TRACKER_DIRECTORY);
