...
using Jenkins.TrayTracker.Utils.BackgroundProcessing;
...
namespace Jenkins.TrayTracker.UI.Controls
{
    public partial class ProjectListControl : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void UpdateProjectList(Server server)
        {
            ...
            Enabled = false;
            string status = string.Format(JenkinsTrayTrackerResources.LoadingProjects_FormatString, server.Url);
            ...
            process.RunWorkerCompleted += delegate(object sender, RunWorkerCompletedEventArgs e)
            {
                ...
                {
                    endStatus = string.Format(JenkinsTrayTrackerResources.FailedLoadingProjects_FormatString, server.Url);
                }
